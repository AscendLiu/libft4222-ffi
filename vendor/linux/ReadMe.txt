...
1.  tar xfvz libft4222-1.4.4.221.tgz
...
This unpacks the archive, creating the following directory structure:
	...
	build-mips-eglibc-sf
	build-mips-el-uclibc-hf
	build-mips-openwrt-uclibc
	build-x86_32
    build-x86_64
    examples
    libft4222.h
...
for dynamic library
This copies the library (libft4222.so.1.4.4.221) and headers to 
...
1.4.4.221
    ...
    Supported platforms : x86_32/x86_64/arm-v6-hf/arm-v7-hf/arm-v7-sf/arm-v8/mips-eglibc-hf/mips-eglibc-sf/mips-el-uclibc-hf/mips-openwrt-uclibc

1.4.4.188
    Add i386 support
    Add API FT4222_GetChipMode   
